...
import ButtonPlus from '@src/components/UI-kit/buttons/ButtonPlus/ButtonPlus'
    ...
    <div className={styles.blocks_container}>
        <section className={styles.blocks}>
            ...
            <div className={styles['blocks-row']}>
                <div className={`${styles.cover} ${styles.meta} ${styles['block-col']}`} style={{backgroundImage: `url("/content/transport/blocks_1.webp")`}}>
            ...
            <div className={styles['blocks-row']}>
                ...
                <div className={`${styles.cover} ${styles.meta} ${styles['block-col']}`} style={{backgroundImage: `url("/content/transport/blocks_2.webp")`}}>
