                ...
                <div className={styles.topInfo}>
                  ...
                  <div className={styles.icons}>
                    <Tooltip title='Избранное' placement='bottom' color='#D38F6D'>
                      <button type='button' className={styles.icon} onClick={() => {
                        addToFavorites(id)
                        ...
                        >
                          <div className={styles.promo}>
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path d="M17.916 8.70829C19.1875 7.39234 18.2705 5.18578 16.4437 5.14809C16.9573 3.39105 15.1226 1.86356 13.4883 2.68103C13.1259 0.887428 10.7933 0.388954 9.72664 1.87425C8.57216 0.45703 6.27558 1.10122 6.02184 2.91283C4.34132 2.19831 2.60566 3.83776 3.22397 5.55935C1.40392 5.7107 0.626395 7.97071 1.97441 9.20564C0.431731 10.1885 0.790677 12.5521 2.5584 13.0151C1.64585 14.6039 3.05913 16.5314 4.84092 16.1168C4.76722 17.9497 6.91189 18.9945 8.29817 17.7973C9.0802 19.4564 11.464 19.3827 12.1386 17.6769C13.5985 18.7841 15.6746 17.6071 15.4838 15.782C17.2887 16.0847 18.5805 14.0745 17.5683 12.5459C19.3057 11.9731 19.5172 9.59215 17.9149 8.70829H17.916Z" stroke="#1F6080" strokeLinejoin="round"/>
                              <path d="M7.52648 9.55102C8.39651 9.55102 9.1018 8.84572 9.1018 7.9757C9.1018 7.10568 8.39651 6.40039 7.52648 6.40039C6.65646 6.40039 5.95117 7.10568 5.95117 7.9757C5.95117 8.84572 6.65646 9.55102 7.52648 9.55102Z" stroke="#1F6080" strokeWidth="1.2" strokeMiterlimit="10"/>
                              <path d="M12.0275 13.602C11.1577 13.602 10.4521 12.8965 10.4521 12.0267C10.4521 11.1569 11.1577 10.4514 12.0275 10.4514C12.8973 10.4514 13.6028 11.1569 13.6028 12.0267C13.6028 12.8965 12.8973 13.602 12.0275 13.602Z" stroke="#1F6080" strokeWidth="1.2" strokeMiterlimit="10"/>
                              <path d="M6.85156 13.6018L12.7027 6.40039" stroke="#1F6080" strokeWidth="1.2" strokeMiterlimit="10"/>
                            </svg>
                            <span>Скидка 15%</span>
                          </div>
                        </Tooltip>
                      ...
                      <>
                        ...
                        <div className={styles.promo}>
                          ...
                          <svg width='24' height='20' viewBox='0 0 24 20' fill='none' xmlns='http://www.w3.org/2000/svg'>
                            ...
                            />
                            <path d='M4.89844 0V2.92307' stroke='#1F6080' strokeWidth='1.2' strokeLinejoin='round' />
                            <path d='M6.35938 7.79492H7.82091' stroke='#1F6080' strokeWidth='1.2' strokeMiterlimit='10' />
                            <path d='M8.79492 7.79492H10.2565' stroke='#1F6080' strokeWidth='1.2' strokeMiterlimit='10' />
                            <path d='M11.2305 7.79492H12.692' stroke='#1F6080' strokeWidth='1.2' strokeMiterlimit='10' />
                            <path d='M13.666 7.79492H15.1276' stroke='#1F6080' strokeWidth='1.2' strokeMiterlimit='10' />
                            <path d='M3.92188 10.2307H5.38341' stroke='#1F6080' strokeWidth='1.2' strokeMiterlimit='10' />
                            <path d='M6.35938 10.2307H7.82091' stroke='#1F6080' strokeWidth='1.2' strokeMiterlimit='10' />
                            <path d='M8.79492 10.2307H10.2565' stroke='#1F6080' strokeWidth='1.2' strokeMiterlimit='10' />
                            <path d='M11.2305 10.2307H12.692' stroke='#1F6080' strokeWidth='1.2' strokeMiterlimit='10' />
                            <path d='M3.92188 12.6665H5.38341' stroke='#1F6080' strokeWidth='1.2' strokeMiterlimit='10' />
                            <path d='M6.35938 12.6665H7.82091' stroke='#1F6080' strokeWidth='1.2' strokeMiterlimit='10' />
                            <path d='M8.79492 12.6665H10.2565' stroke='#1F6080' strokeWidth='1.2' strokeMiterlimit='10' />
                            <path
                              d='M15.8575 14.6153C16.7992 14.6153 17.5626 13.8519 17.5626 12.9102C17.5626 11.9685 16.7992 11.2051 15.8575 11.2051C14.9158 11.2051 14.1523 11.9685 14.1523 12.9102C14.1523 13.8519 14.9158 14.6153 15.8575 14.6153Z'
                              stroke='#1F6080'
                              strokeWidth='1.2'
