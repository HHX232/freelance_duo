    ...
    return (
        <main className={styles['payment-methods']}>
            ...
            <div className={styles.tabs}>
                <button className={clsx([styles['tab-button'], styles.active])}>Рассрочка</button>
                <button className={clsx([styles['tab-button']])}>Ипотека</button>
                <button className={clsx([styles['tab-button']])}>100% оплата</button>
            </div>

            <section className={styles.poster}>
                <h2 className={styles.title}>Рассрочка</h2>
                ...
                <div className={styles['variant-items']}>
                    <div className={styles['variant-row']}>
                        ...
                        <div className={styles.meta}>
                            <p className={styles.meta__pages}><span>1</span>/3</p>
                    ...
                    <div className={styles['variant-row']}>
                        <div className={styles.meta}>
                            <p className={styles.meta__pages}><span>2</span>/3</p>
                            ...
                            <div className={styles.meta__info}>
                                ...
                                <div className={styles['meta__description-wrapper']}>
                                    ...
                                    <p className={styles['meta__description']}>Не менее 10% оплачивается на аккредитив в течение 5 рабочих дней при рассрочке на 3 и 6 месяцев</p>
                                </div>
                                <div className={styles['meta-buttons']}>
                                    <FilledButton>Узнать подробнее</FilledButton>
                                    <BorderedButton className={styles['meta-buttons__bordered']}>Связаться с нами</BorderedButton>
                    ...
                    <div className={styles['variant-row']}>
                        ...
                        <div className={styles.meta}>
                            <p className={styles.meta__pages}><span>3</span>/3</p>
                            ...
                            <div className={styles.meta__info}>
                                ...
                                <div className={styles['meta__description-wrapper']}>
                                    ...
                                    <p className={styles['meta__description']}>Первоначальный взнос не менее 20% от базовой стоимости квартиры, оплачивается при заключении договора (оплата на аккредитив в течение 5 рабочих дней).</p>
                                </div>
                                <div className={styles['meta-buttons']}>
                                    <FilledButton>Узнать подробнее</FilledButton>
                                    <BorderedButton className={styles['meta-buttons__bordered']}>Связаться с нами</BorderedButton>
