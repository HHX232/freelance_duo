...
export const IpotekaTab = () => {
    return (
        <>
            <section className={styles.poster} style={{ backgroundImage: `linear-gradient(90deg, rgba(0, 0, 0, 0.4) 0%, rgba(0, 0, 0, 0) 119.89%), url("/content/payment-methods/ipoteka.jpeg")` }}>
            ...
            <section className={styles.variants}>
                <div className={styles['variant-items']}>
                    <div className={styles['variant-row']}>
                        <div className={styles.cover} style={{ backgroundImage: `url("/content/payment-methods/ipoteka_second.jpeg")` }} />
                        <div className={styles.meta}>
                            <div className={styles.meta__info}>
                                <div className={styles['meta__info-inner']}>
                                    <h3 className={styles['meta__title']}>Одобрение ипотеки<br /><span>по 2 документам</span><br /> за 5 минут</h3>
                                    <p className={clsx(styles['meta__info-inner__caption'])} style={{ color: '#747679' }}>Бесплатная консультация с кредитным специалистом по номеру</p>
                                    <div>
                                        <p className={clsx(styles['meta__info-inner__phone'])}>8 (812) 660–82–71</p>
                                        <p className={clsx(styles['meta__info-inner__caption'])} style={{ color: '#A0A3A8', marginTop: 8 }}>ежедневно с 9:00 до 18:00</p>
                                    </div>
                                </div>
