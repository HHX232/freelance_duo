...
export async function generateMetadata({params}: {params: {param: string}}): Promise<Metadata> {
  ...
  switch (params.param) {
    ...
    case 'kvartiry-s-razdelnym-su':
      ...
      description =
        'Купить однокомнатную, двухкомнатную квартиру с раздельным санузлом в новостройке ЖК «Кронфорт»; продажа квартир с раздельным санузлом в строящемся доме по выгодным ценам в Кронштадте, 40 мин от Санкт-Петербурга'
      break
    case 'kvartiry-s-terrasoi':
      title = 'Квартиры с терассой – купить в строящемся доме ЖК «Кронфорт», Кронштадт'
      description =
        'Купить квартиры с просторной терассой в новостройке от застройщика, уникальные квартиры с открытой площадкой для отдыха с видом на залив в ЖК «Кронфорт», Кронштадт, 40 мин от Санкт-Петербурга.'
      break
    case 'kvartiry-s-balkonom':
      title = 'Квартиры с балконом – купить в строящемся доме ЖК «Кронфорт», Кронштадт'
      description =
        'Купить квартиру с балконом в новостройке от застройщика; продажа квартир с большим балконом с видом на залив в ЖК «Кронфорт», Кронштадт, в 40 мин от Санкт-Петербурга.'
      break
    case 'kvartiry-s-lodzhiei':
      title = 'Квартиры с лоджией – купить в строящемся доме ЖК «Кронфорт», Кронштадт'
      description =
        'Купить квартиру с большой лоджией в новостройке от застройщика; продажа квартир с лоджиями по выгодной цене в ЖК «Кронфорт», Кронштадт, в 40 мин от Санкт-Петербурга.'
      break
    case 'odnokomnatnye':
    ...
    case '3-komnatnye':
      ...
      description =
        'Купить 3-комнатную квартиру со свободной планировкой по выгодной цене напрямую от застройщика, продажа трешек на этапе строительства в 40 мин езды от Санкт-Петербурга в ЖК «Кронфорт», Кронштадт.'
      break
    case 'studii':
