...
export async function generateMetadata(): Promise<Metadata> {
  return {
    ...
    description: 'Выбрать и купить квартиру в строящемся доме по выгодным ценам ЖК «Кронфорт» в Кронштадте; продажа квартир в новостройке от застройщика с видом на залив, в 40 минутах езды от Санкт-Петербурга.',
    alternates: {
